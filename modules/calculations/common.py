...
MIN_SAMPLES_ACTIVE = (
    Config.MIN_RECORDS_FOR_ROLLING if hasattr(Config, "MIN_RECORDS_FOR_ROLLING") else 60
)
...
SLOPE_CONFIDENCE_MAX = (
    Config.SLOPE_CONFIDENCE_MAX if hasattr(Config, "SLOPE_CONFIDENCE_MAX") else 0.4
)
STABILITY_CONFIDENCE_MAX = (
    Config.STABILITY_CONFIDENCE_MAX if hasattr(Config, "STABILITY_CONFIDENCE_MAX") else 0.4
)
