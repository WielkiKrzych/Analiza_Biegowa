...
def render_model_tab(df_plot, cp_input, w_prime_input):
    # Detekcja trybu: rower (watts) vs bieganie (pace)
    is_cycling = 'watts' in df_plot.columns and len(df_plot) > 1200
    is_running = 'pace' in df_plot.columns and 'watts' not in df_plot.columns and len(df_plot) > 1200
    ...
    if is_cycling:
        ...
        st.warning("Za mało danych (wymagane min. 20 minut z pomiarem mocy lub tempa).")
