...
def build_title_page(metadata: Dict[str, Any], styles: Dict) -> List:
    ...
    elements.append(Paragraph("<font size='14'><b>Metryka dokumentu:</b></font>", styles["center"]))
    ...
    meta_data = [
        ...
        [Paragraph("<b>ID sesji:</b>", styles["center"]), Paragraph(session_id, styles["center"])],
        [
    ...
    if bg_image_path and os.path.exists(bg_image_path):
        try:
            ...
            elements.append(
                Paragraph(
                    "<font size='20'><b>Opracowanie: Krzysztof Kubicz</b></font>", styles["center"]
                )
            )
    else:
...
def build_contact_footer(styles: Dict) -> List:
    ...
    # Contact info
    elements.append(Paragraph("<font size='12'><b>Krzysztof Kubicz</b></font>", styles["center"]))
    elements.append(
        Paragraph("<font size='11' color='#1A5276'>kubiczk@icloud.com</font>", styles["center"])
    )
